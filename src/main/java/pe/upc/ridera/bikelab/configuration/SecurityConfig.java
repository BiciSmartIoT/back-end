    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/vehicles", "/api/vehicles/search", "/api/vehicles/*")
                        .permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/iot/devices/*/config")
                        .permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/iot/devices/*/state")
                        .permitAll()
                        .requestMatchers(HttpMethod.PUT, "/api/iot/devices/*/config")
                        .permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/iot/devices/*/commands")
                        .permitAll()
